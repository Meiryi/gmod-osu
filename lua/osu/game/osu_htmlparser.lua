function OSU:GetUserAvatar(steamid64)
		...
		function(body, length, headers, code)
			...
			if(_st) then
				...
				if(__st) then -- If user have avatar frame
							...
							for _i = _fst, _fst + 256, 1 do
								if(string.sub(body, _i, _i + 1) == '">') then
									...
									http.Fetch(string.sub(body, _first, _fend),
										function(body, length, headers, code)
											file.Write("osu!/avatars/frames/"..steamid64..".png", body)
										end,
										function(message)
										end
									)
					...
					file.Write("osu!/avatars/frames/"..steamid64..".png", file.Read("materials/osu/internal/emptyframe.png", "GAME"))
				end
						...
						for _i = i, i + 256, 1 do
							if(string.sub(body, _i, _i) == ">") then
								...
								http.Fetch(string.sub(line, avt_st, avt_ed),
									function(body, length, headers, code)
										file.Write("osu!/avatars/"..steamid64..".png", body)
									end,
									function(message)
									end
								)
