...
function OSU:SetupModsPanel()
	...
	local notestr = OSU:LookupTranslate("#ModNote")
	local dif1 = OSU:LookupTranslate("#ModDiffReduc")
	local dif2 = OSU:LookupTranslate("#ModDiffInc")
	local dif3 = OSU:LookupTranslate("#ModDiffSpec")
	...
	OSU.ModePanel.Paint = function()
		...
		draw.DrawText(notestr, "OSUBeatmapTitle", ScrW() / 2, gap2x, Color(220, 220, 220, 255), TEXT_ALIGN_CENTER)
		...
		draw.DrawText(dif1, "OSUBeatmapTitle", textpadding, ScrH() * 0.3, Color(70, 255, 70, 255), TEXT_ALIGN_LEFT)
		draw.DrawText(dif2, "OSUBeatmapTitle", textpadding, ScrH() * 0.425, Color(255, 70, 70, 255), TEXT_ALIGN_LEFT)
		draw.DrawText(dif3, "OSUBeatmapTitle", textpadding, ScrH() * 0.55, Color(220, 220, 220, 255), TEXT_ALIGN_LEFT)
	end
