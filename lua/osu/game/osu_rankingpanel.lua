...
function OSU:SetupRankingPanel(toState, parent)
	...
	local t1 = OSU:LookupTranslate("#RankingLeaderboard")
	local t2 = OSU:LookupTranslate("#RankingName")
	local t3 = OSU:LookupTranslate("#RankingNum")
	local t4 = OSU:LookupTranslate("#RankingScore")
	local t5 = OSU:LookupTranslate("#Acc")
	local t6 = OSU:LookupTranslate("#RankingTotalPlay")
	...
	local titleBlock = OSU:CreateFrame(OSU.RankingPanel, 0, topPadding, ScrW(), titleHeight, Color(41, 31, 37, 255), false)
		titleBlock.Paint = function()
			...
			draw.DrawText(t1, "OSULeaderboardRankingTitle", titleBlock:GetWide() / 2, ScreenScale(2), Color(255, 255, 255, 255), TEXT_ALIGN_CENTER)
			draw.DrawText(t2, "OSULeaderboardRankingDetails", namepad, detailPos, Color(255, 255, 255, 255), TEXT_ALIGN_LEFT)
			draw.DrawText(t3, "OSULeaderboardRankingDetails", rankpad, detailPos, Color(255, 255, 255, 255), TEXT_ALIGN_RIGHT)
			draw.DrawText(t4, "OSULeaderboardRankingDetails", scorepad, detailPos, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER)
			draw.DrawText(t5, "OSULeaderboardRankingDetails", accuracypad, detailPos, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER)
			draw.DrawText(t6, "OSULeaderboardRankingDetails", playspad, detailPos, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER)
		end
